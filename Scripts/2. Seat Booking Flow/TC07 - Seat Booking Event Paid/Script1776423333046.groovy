...
String ticketName = 'Katalon Seat Tier'
String ticketPrice = '20'
String ticketQuantity = '94'
String maxTicketPerUser = '5'
...
String couponCode = 'SAVE'
String couponDesc = 'SAVE 10% OF ALL KATALON TICKETS'
String couponValue = '10'

String eventLocation = "Casablanca"
String seatRowFrom = 'A'
String seatRowTo = 'D'
String seatColumnFrom = '1'
String seatColumnTo = '30'
...
// 6. Ticketing
// WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_ticketingPaid_Add Tier'))

// Tiers
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/Ticketing and Pricing/button_Free Event'), 30)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_tierTicketName'), ticketName)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_tierPrice'), ticketPrice)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_tierQuantity'), ticketQuantity)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_tierMaxTicket'), maxTicketPerUser)

// reg_end_date
WebUI.enhancedClick(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_regClose'))
...
// reg_start_date
WebUI.enhancedClick(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_regStart'))
...
// Coupons
WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_ticketingPaid_Add Coupon Code'))

WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_couponCode'), couponCode)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_couponDesc'), couponDesc)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_ticketingPaid_couponValue'), couponValue)

WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_ticketingPaid_couponSave'))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/Location Configuration/input_eventLocation_venueName'), 20)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/Location Configuration/select_eventLocation_seatMap'), '698dac1b3d93d9839087558a',
	false)

WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_locationConfig_ticketButton'))
WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_locationConfig_ticketConfigure'))

WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_locationConfig_Row range(from)'), seatRowFrom)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_locationConfig_Row range(to)'), seatRowTo)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_locationConfig_Seat range(from)'), seatColumnFrom)
WebUI.setText(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/input_locationConfig_Seat range(to)'), seatColumnTo)

WebUI.click(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/SeatBookingPaid/button_locationConfig_saveSection'))
...
// 16. Publish
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_marQ - Event Management/Seat Booking Flow/Preview and Publish/button_Publish'), 20)
